            ...
            <div class="max-w-6xl mx-auto bg-[#F0F8FF] rounded-lg">
                <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <p class="text-sm text-gray-400 mt-3">Get in touch with us! We welcome your inquiries, feedback, and collaboration ideas. Whether you have questions about our products or
...
soon.</p>
                        <ul class="mt-12 space-y-8">
                            ...
                            <li class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='black' viewBox="0 0 482.6 482.6">
                            ...
                            <li class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='black' viewBox="0 0 368.16 368.16">
            ...
            <path d="M12 3c-2.56 0-5.12.12-7.68.44C2.51 3.61 2 5.6 2 7.99v8.02c0 2.39.51 4.38 2.32 4.54 2.56.32 5.12.44 7.68.44 2.56 0 5.12-.12 7.68-.44 1.81-.16 2.32-2.15 2.32-4.54V7.99c0-2.39-.51-4.38-2.32-4.54-2.56-.32-5.12-.44-7.68-.44zM9.91 15.23V8.77L15.67 12l-5.76 3.23z"></path>
                    ...
                    <p class="text-lg font-semibold text-[#333] text-center">Unlock Customized Solutions <br></br> Submit Your Inquiry Form Today!</p>
                        ...
                        <form class="mt-8 space-y-4">
                            ...
                            <input type='email' placeholder='Business Name'
                                class="w-full rounded-md py-3 px-4 text-sm outline-[#51abae]" />
