...
function Home1() {
  return (
    ...
    <Carousel.Item>
      ...
      />
      <Carousel.Caption>
        <h3 className='carosel-heding'>Sending a Smile across the borders
</h3>
...
Proudly Certified with ISO 9001:2015 Standard</p>
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        <h3 className='carosel-heding'>As leading importers and exporters in India, we prioritize quality standards in all our endeavors</h3>
        <p>Explore our
...
us for a reliable and rewarding trading experience</p>
      </Carousel.Caption>
    </Carousel.Item>
    <Carousel.Item>
      <img style={{height:'100vh'}}
      ...
      <Carousel.Caption>
        <h3 className='carosel-heding'>Sending a Smile across the borders</h3>
        <p>
