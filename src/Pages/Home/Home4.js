  ...
  return (
    <section className=" Our-Products overflow-hidden">
      ...
      <Row>
        <Col lg={{ span: 8, offset: 2 }} className="text-center">
          ...
          <motion.p
           ...
           className="home-para">
            Explore our company, your ultimate destination in India for a
            diverse range of high-quality products. Our team of experienced
            professionals carefully selects each product to ensure top-notch
            quality. We take pride in exporting premium products. Explore our
            highlighted categories below, and for more information on additional
            categories or products, feel free to contact us using the details
            provided. Your satisfaction is our priority
          </motion.p>
        </Col>
      </Row>
      ...
      {/* <motion.div className="Product" 
          ...
          whileInView="visible"
          > */}
      <motion.div className="home-map-parent"  initial="hidden"
          variants={boxvariants}
          whileInView="visible">
        {product.map((prodData, index) => (
          // <motion.div key={index} className="" variants={listvariants}>
          <motion.div key={index} lassName="" variants={listvariants}>
            <div className="home-mp-cont ">
              <div className="home-img-par">
              <img
