...
const Footer = () => {
  ...
  const contactInfo = [
    {
      icon:  <FaMapMarkerAlt />,
      text1: <p className='f_contacts mt'>'Regd. Office: MH Nochanwala Exporter, City Kamptee, Pin Code 441001 District Nagpur, Maharashtra State, INDIA'</p>
    },
    { icon: <FaPhoneAlt/>, text1: <p className='f_contacts mt'>'+91 9307091009 '</p>, text2:<p className='f_contacts mt'>'+91 9370026214' </p>},
    { icon: <FaEnvelope />, text1: <p className='f_contacts mt' >'info@mhnochanwala.com'</p>, text2:<p className='f_contacts mt'>'mhnochanwala@gmail.com'</p>},
  ];
...
>
        <div className="container py-5">
          <div className="row g-4">
            ...
            <div className="col-lg-3 col-md-6">
            <h4 className="section-title ff-secondary text-start fw-normal mb-4" style={{ color: 'rgb(247, 190, 39)' }}>
